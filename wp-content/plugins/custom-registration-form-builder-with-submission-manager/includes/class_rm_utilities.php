...
class RM_Utilities {
            ...
            if (!$redirect_to){
                ...
                switch ($redirect_to) {
                    case "__current_url":
                                    ...
                                    break;
                    case "__home_page":
                                        $redirect_to= get_home_url(); break;

                    case "__dashboard":
                                        $redirect_to= admin_url(); break;
	...
	$id = $wpdb->get_var($sql);
        if(empty($id)){
            $recovery_page = array(
            'post_type' => 'page',
            'post_title' => __('Password Recovery','registrationmagic-gold'),
            'post_status' => 'publish',
...
// format date string
    ...
    public static function check_smtp() {
        ...
        $test_email->message = 'Check myu submission';
        $test_email->header = '';
    ...
    public static function format_on_time($t) {
     ...
     public static function get_form_expiry_message($form_id){
         ...
         $exp_str='';
         if ($expiry_details->state !== 'perpetual')
          {
  ...
  public function rm_delete_data(){
    ...
    public static function comparison_page_link(){
        ...
        if(!empty($mgp))
            return 'https://metagauss.com/get-registrationmagic-for-wordpress/?mgp=' . $mgp;
        else
            return 'https://registrationmagic.com/comparison/';
    }

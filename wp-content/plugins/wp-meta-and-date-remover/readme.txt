...
**Custom removal using little coding**
...
Remove only date from only older posts best for SEO
...
For further help refer [this](https://wpxlearn.com/how-to-install-wp-free-ssl-certificate/) blog post

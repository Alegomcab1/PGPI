...
<<<<<<< HEAD
	...
	<?php if(get_theme_mod('honeypress_enable_single_post_admin') != '' || get_theme_mod('honeypress_enable_single_post_date') != '' || get_theme_mod('honeypress_enable_single_post_comments') != '') { ?>	
